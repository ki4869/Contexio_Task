...
public class writeexcel {
	...
	public static void main(String[] args) {
        ...
        headerStyle.setFillForegroundColor(IndexedColors.YELLOW.getIndex()); //code to set header color
       headerStyle.setFillPattern(FillPatternType.SOLID_FOREGROUND); 
		...
		while (true) {
          ...
          //  row.createCell(5).setCellValue(empStatus);
            ...
            Cell statusCell =row.createCell(5);  //code to set text color of empstatus
